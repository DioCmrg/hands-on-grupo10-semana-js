...
async function viewEvent() {
    try {
        const resposta = await fetch(`https://xp41-soundgarden-api.herokuapp.com/bookings/${idUrl}`, {
            headers: {
...
newForm.onsubmit = async (e) => {
    ...
    try {
        ...
        const respostaEdit = await fetch(`https://xp41-soundgarden-api.herokuapp.com/bookings/${idUrl}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
